...
2. Before expanding a task beyond the plan's stated boundary, stop and tell the owner what expanded,
   why, the expected cost, and what later tasks would be displaced. Expansion requires an explicit
...
5. If a proof is blocked by shared infrastructure, preserve the honest gap and switch to another
